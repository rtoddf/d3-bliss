...
var Cities = new function(){
	this.get = function(city){
		...
		switch (city){
			case 'atlanta':
				cityData = '../../data/cities/atlanta.json'
				...
				break;
			case 'boston':
				cityData = '../../data/cities/boston.json'
				...
				break;
			case 'chicago':
				cityData = '../../data/cities/chicago.json'
				...
				break;
			case 'dallas':
				cityData = '../../data/cities/dallas.json'
				...
				break;
			case 'detroit':
				cityData = '../../data/cities/detroit.json'
				...
				break;
			case 'los-angeles':
				cityData = '../../data/cities/los-angeles.json'
				...
				break;
			case 'minneapolis':
				cityData = '../../data/cities/minneapolis.json'
				...
				break;
			case 'new-york':
				cityData = '../../data/cities/new-york.json'
				...
				break;
			case 'philadelphia':
				cityData = '../../data/cities/philadelphia.json'
				...
				break;
			case 'seattle':
				cityData = '../../data/cities/seattle.json'
